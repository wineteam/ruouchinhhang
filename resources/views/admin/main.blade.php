       ...
       <div class="col-md-4">
        <div class="block-statistical">
          ...
          <div class="link-to-category">
            ...
            <a href="#">{{__('totally')}} {{$productsCount}} {{__('product')}}</a>
          </div>
        </div>
       </div>
       <div class="col-md-4">
       ...
       <div class="col-md-4">
        <div class="block-statistical">
          ...
          <div class="link-to-category">
            ...
            <a href="#">{{$usersCount}} {{__('accountuser')}}</a>
          </div>
        </div>
       </div>
    </div>
       ...
       <div class="block-statistical">
         ...
         <div class="link-to-category">
          <img src="{{ asset('Images/IconImages/blog.png') }}" width="10%" alt="" style="z-index: 1000">             
           <a href="#">{{__('totally')}} {{$blogsCount}} {{__('BLOG')}}</a>
         </div>
       </div>
      </div>
      <div class="col-md-4">
       <div class="block-statistical">
         ...
         <div class="link-to-category">
          <img src="{{ asset('Images/IconImages/comment.png') }}" width="10%" alt="" style="z-index: 1000">         
           <a href="#">{{NULL}} {{__('comment')}} / {{__('reviews')}}</a>
         </div>
       </div>
      </div>
      <div class="col-md-4">
       <div class="block-statistical">
         ...
         <div class="link-to-category">
          <img src="{{ asset('Images/IconImages/catelog.png') }}" width="10%" alt="" style="z-index: 1000">
           <a href="#">{{$categoriesCount}} {{__('catelog')}}</a>
         </div>
       </div>
      </div>
   </div>
