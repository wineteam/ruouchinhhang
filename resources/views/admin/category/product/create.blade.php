      ...
      <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                  <form method="POST" action="{{route('MngCateLogProDuct.store')}}" enctype="multipart/form-data">
                  @csrf
                    <div class="form-group">
                      <label for="name">Tên Danh mục Sản phẩm</label>
                    <input type="text" class="form-control" name="name" value="{{old('name')}}" id="name" placeholder="Nhập tên Danh mục Sản phẩm">
                      @error('name')
