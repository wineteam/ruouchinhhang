        ...
        <div class="col-6 col-10 mx-auto">
            <div id="myBtnContainer" class="text-center">
                <button class="btnfilter nobtnshow" onclick="filterSelection('all')">
                    <img class="rounded mx-auto d-block" style="margin-bottom: 0.3rem;" width="40" height="auto" src="content/images/wine-glass.png" alt="">
...
<div class="row">
    ...
    <div class="col-xl-4 col-md-6 col-sm-12 nopadding Display-None">
        <div class="">
            <div class="vc_custom_1">
                <img src="{{ asset('images/bg-5.webp') }}" alt="">
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-md-6 col-sm-12 bg-items-3 nopadding">
        <div class="wpb_wrapper">
            ...
            <div class="vc_empty_space" style="height: 2.8em"><span class="vc_empty_space_inner"></span></div>
            <div>
                <figure><div><img class="rounded mx-auto d-block" width="71" height="90" src="{{ asset('images/img_2.webp') }}" alt=""></div></figure>
...
<div class="row">
    <div class="col-xl-4 col-md-6 col-sm-12 nopadding Display-None">
        <div class="">
            <div class="vc_custom_2">
                <img src="{{ asset('images/bg-6.webp') }}" alt="">
            </div>
        </div>
    </div>
    <div class="col-xl-4 col-md-6 col-sm-12 bg-items-5 nopadding">
        <div class="wpb_wrapper">
            ...
            <div class="vc_empty_space" style="height: 2.8em"><span class="vc_empty_space_inner"></span></div>
            <div>
                <figure><div><img class="rounded mx-auto d-block" width="71" height="90" src="{{ asset('images/img_1.webp') }}" alt=""></div></figure>
...
<div class="container-fluid bg-white">
    <div class="row">
        <div class="col-xl-6 col-md-6 col-sm-12 nopadding bg-purple">
            <div class="wpb_wrapper" style="padding: 20.3% 16%;">
                <div id="" class="">
                    <h1 class="sc_item_title Font-white" style="font-size: 3.5rem;">Our wines are some of the best wines in the world!</h1>
                    <div class="item_descr Font-white" style="width: 70%">
                    Sed eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip commodo consequat
                    </div>
                    <div class="mr-subtitle">
                        <a href=""class="btn-subtitle-Info" style="float: left;">Learn More</a>
                    </div>
                    </div>
                <div class="vc_empty_space" style="height: 3.2em"><span class="vc_empty_space_inner"></span></div>
            </div>
        </div>
        <div class="col-xl-6 col-md-6 col-sm-12 nopadding" style="overflow: hidden;">
            <img style="right: 0;width: 110%;" src="{{ asset('images/promo-3.webp') }}" alt="">
        </div>
    </div>
</div>
<div class="container-fluid bg-purple2">
    <div class="container" style="width: 100%;">
        <div class="row">
            <div class="col-xl-6 col-md-6 col-sm-12 nopadding">
                <div class="wpb_wrapper">
                    <div class="vc_empty_space" style="height: 6.6em"><span class="vc_empty_space_inner"></span></div>
                    <div id="" class="">
                        <h3 class="sc_item_title"><span class="Font-white">Fresh News from Luxury Wine</span></h3>
                        <div style="width: 70%;">
                            <span class="Font-white">Try our great variety of wines for every price point and any occasion, from rich shardonnay to elegant brut.</span> 
                        </div>
                    </div>
                    <div class="vc_empty_space" style="height: 6.6em"><span class="vc_empty_space_inner"></span></div>
                </div>
            ...
            <div class="col-xl-6 col-md-6 col-sm-12 nopadding">
                ...
                <form action="">
                    ...
                    <div class="email-submit-info"><input type="submit" value="Subscribe"></div>
                </form>
                <div class="vc_empty_space" style="height: 6.6m"><span class="vc_empty_space_inner"></span></div>
            </div>
        </div>
        <div class="vc_empty_space_moblie"><span class="vc_empty_space_inner"></span></div>
    </div>
