...
class HomePageController extends Controller
{
    public function index(){
        ...
        $blogs_esp = Blog::where('is_published','1')->where('especially','1')->inRandomOrder()->take(3)->orderBy('view','desc')->get();
        return view('client.homepage')->with(['products'=>$products,'blogs_esp'=>$blogs_esp]);
    }
}
